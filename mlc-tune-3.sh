...
#SBATCH --job-name              MLC-tune
#SBATCH --output                log/MLC-tune.%j.out
#SBATCH --error                 log/MLC-tune.%j.err
...
# python -u mlc-tune-3.py --seed 0 --split variants
python -u mlc-tune-3.py --seed 1 --split frames
